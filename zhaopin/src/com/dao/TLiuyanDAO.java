...
public class TLiuyanDAO extends HibernateDaoSupport
{
	...
	public TLiuyan ansower(TLiuyan liuyan) {
		
		log.debug("getting TLiuyan instance with id: " + liuyan.getLiuyanId());
		try
		{
			TLiuyan instance = (TLiuyan) getHibernateTemplate().get(
					"com.model.TLiuyan", liuyan.getLiuyanId());
			return instance;
		} catch (RuntimeException re)
		{
			log.error("get failed", re);
	...
	public void update(TLiuyan instance) {
		log.debug("attaching dirty Tliuyan instance");
		try
		{
