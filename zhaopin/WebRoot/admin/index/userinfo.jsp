...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="body-box">
			<form method="post" action="<%=path %>/adminPwEdit.action" name="formPw" onsubmit="return check()">
			<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
				...
				<tr>
				    ...
				    <td width="80%" class="pn-fcontent">
				        <input type="password" name="userPw" id="userPw" size="22" value="${sessionScope.admin.userPw}"/>
				    </td>
				</tr>
				<tr> 
				    <td width="20%" class="pn-flabel pn-flabel-h">
