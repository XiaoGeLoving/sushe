		...
		<div class="body-box">
			...
			<table class="pn-ltable" width="100%" cellspacing="1" cellpadding="0" border="0">
				...
				<tbody class="pn-ltbody">
					<s:iterator value="#request.page.data" id="user">
					<tr onmouseover="Pn.LTable.lineOver(this);" onmouseout="Pn.LTable.lineOut(this);" onclick="Pn.LTable.lineSelect(this);">
						...
						<td class="pn-lopt">
							...
							<a href="#" onclick="adminDel(<s:property value="#user.userId"/>)" class="pn-loperator">删除</a>
						</td>
					</tr>
					</s:iterator>
				</tbody>
			</table>
			<div class="pn-lnoresult"><s:property value="#request.page.pageDisplay" escape="false"/></div>
			<div class="pn-sp">
				<div class="clear"></div>
			</div>
			<div class="pn-lbopt">
				...
				&nbsp;&nbsp;
				<input type="button" value="添加" style="width: 80px;" onclick="adminAdd1()" />
			</div>
		    </form>
		</div>
	</body>
