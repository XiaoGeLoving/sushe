...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
       ...
       <script language="javascript">
           function userQiyeDel(userId)
           {
               if(confirm('您确定删除吗？'))
               {
                   window.location.href="<%=path %>/userQiyeDel.action?userId="+userId;
               }
           }
       </script>
	</head>
			...
			<table class="pn-ltable" width="100%" cellspacing="1" cellpadding="0" border="0">
				...
				<s:iterator value="#request.userList" id="user">
					<tr onmouseover="Pn.LTable.lineOver(this);" onmouseout="Pn.LTable.lineOut(this);" onclick="Pn.LTable.lineSelect(this);">
						...
						<td align="center">
							<s:property value="#user.userOne2"/><!--从事行业  -->
						</td>
						<td align="center">
							<s:property value="#user.userOne1" escape="false"/><!-- 企业简介 -->
						</td>
						<td class="pn-lopt">
							<a href="#" onclick="userQiyeDel(<s:property value="#user.userId"/>)" class="pn-loperator">删除</a>
						</td>
					</tr>
					</s:iterator>
