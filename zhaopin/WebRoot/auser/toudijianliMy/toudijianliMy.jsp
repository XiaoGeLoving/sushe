...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
       ...
       <script language="javascript">
           function toudijianliMyDel(id)
           {
               if(confirm('您确定删除吗？'))
               {
                   window.location.href="<%=path %>/toudijianliMyDel.action?id="+id;
               }
           }
           function zhaopinDetail(id)
           {
                var url="<%=path %>/zhaopinDetail.action?id="+id;//此id是招聘信息的id
                //alert(url);
                var n="dd";
                var w="400px";
                var h="400px";
			...
			<table class="pn-ltable" width="100%" cellspacing="1" cellpadding="0" border="0">
				...
				<tbody class="pn-ltbody">
					...
					<tr onmouseover="Pn.LTable.lineOver(this);" onmouseout="Pn.LTable.lineOut(this);" onclick="Pn.LTable.lineSelect(this);">
						...
						<td align="center">
							<a href="#" onclick="zhaopinDetail(<s:property value="#toudijianli.zhaopinId"/>)">招聘信息</a>
						</td>
					<%-- 	<td class="pn-lopt">
							<a href="#" onclick="toudijianliMyDel(<s:property value="#toudijianli.Id"/>)" class="pn-loperator">删除</a>
						</td> --%>
					</tr>
					</s:iterator>
				</tbody>
