				...
				<TR>
					<TD class=Main  height=111>
						<TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
								<TR>
									<TD class=head>
										<SPAN class=TAG style="mso-spacerun:'yes'; font-family:黑体; font-size:12.0000pt; mso-font-kerning:0.0000pt;">公告详情</SPAN>
									</TD>
								</TR>
								<TR align="left">
									<TD height=500>
									    <table  cellspacing="8" cellpadding="0" >
									        <tr>
									            <td><span style="mso-spacerun:'yes'; font-family:宋体; font-size:12.0000pt; mso-font-kerning:0.0000pt;"><s:property value="#request.gonggao.gonggaoTitle"/></span></td>
									            
									           
									        </tr>
									        <tr> <td><SPAN  style="mso-spacerun:'yes'; font-family:宋体; font-size:12.0000pt; mso-font-kerning:0.0000pt;">发布时间：<s:property value="#request.gonggao.gonggaoData"/></span></td></tr>
									        <tr>
									            <td colspan="2">
									            
									            <%-- <s:property value="#request.gonggao.gonggaoContent"/> --%>
									            <SPAN  style="mso-spacerun:'yes'; font-family:宋体; font-size:12.0000pt; mso-font-kerning:0.0000pt;">内容： <br>
									            ${request.gonggao.gonggaoContent}</SPAN>
									...
									<%-- <TD height=500>
									    <table style="MARGIN-TOP: 1px" cellspacing="8" cellpadding="0" width=”100%“>
									        <tr>
									            <td>新闻标题：<s:property value="#request.news.newsTitle"/></td>									           									            									            
									        </tr>
									          <tr>							            
									        ...
									        <tr>
						                         <td  class="pn-flabel pn-flabel-h">
						                                                                                      新闻 内容： <br><FCK:editor instanceName="newsContent"  basePath="/fckeditor" width="800" height="300" value="#request.news.newsContent" toolbarSet="Basic">${request.news.newsContent}</FCK:editor>
						                       </td>									    									    
